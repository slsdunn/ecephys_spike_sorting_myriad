...
toStream_sync_params = 'XA=0,1,3,500'  # sync channel on probe 
niStream_sync_params = 'XA=0,1,3,500'   # 1Hz imec input to nidaq   # copy from ni_extract_string, set to None if no Aux data, no spaces
