...
logName = 'sglx_multi_run_pipeline_log.csv'

# Raw data directory = npx_directory
# run_specs = name, gate, trigger and probes to process
npx_directory = r'/home/ucbtlsd/Scratch/Data'
...
catGT_dest = r'/home/ucbtlsd/Scratch/sglx_pipeline_output'
...
ni_present = True
ni_extract_string = '-XD=4,0,500 -XD=4,6,0 -XD=4,7,500,260'
...
toStream_sync_params = 'SY=0,-1,6,500'  # sync channel on probe 
niStream_sync_params = 'XD=4,0,500'   # 1Hz imec input to nidaq   # copy from ni_extract_string, set to None if no Aux data, no spaces
